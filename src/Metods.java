...
public class Metods {
    public char[] reader(String pathFile) throws IOException {
    ...
    public  void writer(String pathFile, char[] buffer) throws IOException {
    ...
    public  char[] offsetArray(char[] buffer, int offset) {
